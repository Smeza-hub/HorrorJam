...
@export var spring_strength: float = 150    # Higher = snappier lower = floatier
@export var damping: float = 10             # Higher = less overshoot
@export var float_amplitude: float =0      # How much the light floats around
@export var float_speed: float = 0          # How fast it floats

@export var flicker_enabled: bool = true
@export var flicker_intensity: float = 10   # Max variation in energy
@export var flicker_speed: float = 3.0      # How fast it flickers
@export var base_energy: float = 4.0         # The "normal" brightness
